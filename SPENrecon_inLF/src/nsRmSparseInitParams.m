function params                = nsRmSparseInitParams(params)
    ...
    % mask for D1
    tImMask                    = logical(imresize(logical(params.ImMask),round([params.ND1(1),params.ND1(2)]*params.NosD1)));
    twaterMask                = logical(imresize(logical(params.waterMask),round([params.ND1(1),params.ND1(2)]*params.NosD1)));
    ...
    % mask for D2
    tImMask                    = logical(imresize(logical(params.ImMask),round([params.ND2(1),params.ND2(2)])));
    twaterMask                = logical(imresize(logical(params.waterMask),round([params.ND2(1),params.ND2(2)])));
