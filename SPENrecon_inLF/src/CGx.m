...
% backtracking line-search
	...
	[FTtx, FTtdx, Dtx, Dtdx] = preobjective(x, dx, params);
	f0 = objective(FTtx, FTtdx, Dtx, Dtdx, 0, params);
	t = t0;
        [f1, ~, ~]  =  objective(FTtx, FTtdx, Dtx, Dtdx, t, params);
...
function [FTtx, FTtdx, Dtx, Dtdx] = preobjective(x, dx, params)
...
function [res, obj, RMS] = objective(FTtx, FTtdx, Dtx, Dtdx, t, params)
...
gradObj = (x - params.data);
gradObj = (1-params.BW).*gradObj;
gradObj = 2*gradObj ; 
